...
@Component({
  selector: 'kyr-user-newsletters-search',
  templateUrl: './user-newsletters-search.component.html',
})
export class UserNewslettersSearchComponent
    ...
    this.form = this.fb.group({
      ...
      searchFields: this.fb.group({
        ...
        subject: this.fb.group({
          searchWordLabel: this.i18nextPipe.transform(
            `${this.modulePath}:model.subject`
          ),
          value: null,
        }),
        sent_at: this.fb.group({
          searchWordLabel: this.i18nextPipe.transform(
            `${this.modulePath}:model.sent_at`
          ),
          value: null,
        }),
        read: this.fb.group({
          searchWordLabel: this.i18nextPipe.transform(
            `${this.modulePath}:model.read`
          ),
          value: null,
        }),
      }),
