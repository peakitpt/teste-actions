...
import { NewsletterGroupSubscription } from '../../newsletter-group-subscription.model';
import * as actions from '../../reducers/newsletter-group-subscriptions.actions';

@Component({
  selector: 'kyr-newsletter-group-subscription-toggle-confirmation',
  templateUrl:
    './newsletter-group-subscriptions-toggle-confirmation.component.html',
})
export class NewsletterGroupSubscriptionsToggleConfirmationComponent
  ...
  private actionRequestFailToggle =
    actions.NewsletterGroupSubscriptionsActionTypes.RequestFailToggle;
  private actionSuccessToggle =
    actions.NewsletterGroupSubscriptionsActionTypes.SuccessToggle;
  private actionRequestGetAll = actions.RequestGetAll;

  @Input() model: NewsletterGroupSubscription;
  ...
  toggle() {
    this.isSaving = true;
    this.isLoading = true;
    this.store.dispatch(new this.actionRequestToggle(this.model.id));
  }
}
