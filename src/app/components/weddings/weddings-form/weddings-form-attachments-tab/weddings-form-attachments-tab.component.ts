...
import { WeddingsAttachment } from '../../wedding.model';

@Component({
  selector: 'kyr-weddings-form-attachments-tab',
  templateUrl: './weddings-form-attachments-tab.component.html',
})
export class WeddingsFormAttachmentsTabComponent {
  ...
  addAttachment(event: any) {
    if (event.target.files && event.target.files[0]) {
      const newAttachment: WeddingsAttachment = {
        attachment: null,
