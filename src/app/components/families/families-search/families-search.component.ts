...
@Component({
  selector: 'kyr-families-search',
  templateUrl: './families-search.component.html',
  encapsulation: ViewEncapsulation.None,
})
export class FamiliesSearchComponent
  ...
  buildForm() {
    this.form = this.fb.group({
      ...
      searchFields: this.fb.group({
        ...
        father_description: this.fb.group({
          searchWordLabel: this.i18nextPipe.transform(
            `${this.modulePath}:model.father_description`
          ),
          value: null,
        }),
        mother_description: this.fb.group({
          searchWordLabel: this.i18nextPipe.transform(
        ...
        disabled: this.fb.group({
          searchWordLabel: this.i18nextPipe.transform(
            `${this.modulePath}:model.disabled`
          ),
          value: null,
        }),
      }),
