...
@Component({
  selector: 'kyr-curia-weddings-details-grooms-tab',
  templateUrl: './curia-weddings-details-grooms-tab.component.html',
})
export class CuriaWeddingsDetailsGroomsTabComponent {
