...
@Component({
  selector: 'kyr-curia-weddings-details-wedding-tab',
  templateUrl: './curia-weddings-details-wedding-tab.component.html',
})
export class CuriaWeddingsDetailsWeddingTabComponent implements OnInit {
