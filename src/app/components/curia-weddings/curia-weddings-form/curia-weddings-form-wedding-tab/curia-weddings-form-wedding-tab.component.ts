...
@Component({
  selector: 'kyr-curia-weddings-form-wedding-tab',
  templateUrl: './curia-weddings-form-wedding-tab.component.html',
})
export class CuriaWeddingsFormWeddingTabComponent {
