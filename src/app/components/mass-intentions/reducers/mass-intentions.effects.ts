...
@Injectable()
export class MassIntentionsEffects {
  @Effect()
  RequestGetAll = this.actions$.pipe(
    ofType(actions.MassIntentionsActionTypes.RequestGetAll),
    map((action: actions.SuccessGetAll) => action.payload),
    switchMap((payload) => {
      return this.service.getAll(payload).pipe(
        map(
          (response: MassIntentionResponse) =>
        ...
        catchError((error) =>
          of(
            new actions.RequestFail(
              new RequestError(
                actions.MassIntentionsActionTypes.RequestGetAll,
                error
              )
            )
          )
  ...
  RequestGet = this.actions$.pipe(
    ofType(actions.MassIntentionsActionTypes.RequestGet),
    map((action: actions.SuccessGet) => action.payload),
    switchMap((payload) => {
      return this.service.getOne(+payload).pipe(
        map((response: MassIntention) => new actions.SuccessGet(response)),
        catchError((error) =>
          of(
            new actions.RequestFail(
              new RequestError(
                actions.MassIntentionsActionTypes.RequestGet,
                error
              )
            )
          )
  ...
  RequestPost = this.actions$.pipe(
    ofType(actions.MassIntentionsActionTypes.RequestPost),
      ...
      return this.service.create(payload).pipe(
        ...
        catchError((error) => {
          return of(
            new actions.RequestFail(
              new RequestError(
                actions.MassIntentionsActionTypes.RequestPost,
                error
              )
            )
          );
  ...
  RequestPut = this.actions$.pipe(
    ofType(actions.MassIntentionsActionTypes.RequestPut),
      ...
      return this.service.update(payload).pipe(
        ...
        catchError((error) =>
          of(
            new actions.RequestFail(
              new RequestError(
                actions.MassIntentionsActionTypes.RequestPut,
                error
              )
            )
          )
  ...
  RequestDelete = this.actions$.pipe(
    ofType(actions.MassIntentionsActionTypes.RequestDelete),
      ...
      return this.service.delete(+payload).pipe(
        ...
        catchError((error) =>
          of(
            new actions.RequestFail(
              new RequestError(
                actions.MassIntentionsActionTypes.RequestDelete,
                error
              )
            )
          )
  ...
  RequestBulkDelete = this.actions$.pipe(
    ofType(actions.MassIntentionsActionTypes.RequestBulkDelete),
      ...
      return this.service.bulkDelete(payload).pipe(
        ...
        catchError((error) => {
          return of(
            new actions.RequestFail(
              new RequestError(
                actions.MassIntentionsActionTypes.RequestBulkDelete,
                error
              )
            )
          );
  ...
  RequestGetEntirely = this.actions$.pipe(
    ofType(actions.MassIntentionsActionTypes.RequestGetEntirely),
      ...
      return this.service.getAll(payload.payload).pipe(
        ...
        catchError((error) =>
          of(
            new actions.RequestFail(
              new RequestError(
                actions.MassIntentionsActionTypes.RequestGetEntirely,
                error
              )
            )
          )
  ...
  RequestSaveAndGenerateDocument = this.actions$.pipe(
    ofType(actions.MassIntentionsActionTypes.RequestSaveAndGenerateDocument),
    map((action: actions.SuccessSaveAndGenerateDocument) => action.payload),
    switchMap((payload) => {
      return this.service
        .saveAndGenerateDocument(payload as MassIntention)
        .pipe(
          map(
          ...
          catchError((error) =>
            of(
              new actions.RequestFailSaveAndGenerateDocument(
                new RequestError(
                  actions.MassIntentionsActionTypes.RequestSaveAndGenerateDocument,
                  error
                )
              )
            )
  ...
  constructor(
    ...
    private service: MassIntentionsService
  ) {}
}
