...
@Component({
  selector: 'kyr-persons-details-reports-tab',
  templateUrl: './persons-details-reports-tab.component.html'
})
export class PersonsDetailsReportsTabComponent implements OnInit {
