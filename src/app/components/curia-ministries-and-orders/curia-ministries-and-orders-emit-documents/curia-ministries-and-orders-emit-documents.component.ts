...
@Component({
  selector: 'kyr-curia-ministries-and-orders-emit-documents',
  templateUrl: './curia-ministries-and-orders-emit-documents.component.html',
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class CuriaMinistriesAndOrdersEmitDocumentsComponent
  ...
  implements OnInit, AfterViewInit, OnDestroy
{
    ...
    this.subs.push(
      this.route.params.subscribe((params) => {
        ...
        if (params.id && this.preFillWithNew) {
          ...
          this.subs.push(
            this.service
              .getNewCuriaMinistriesAndOrderDocument(this.id)
              .subscribe((obj: any) => {
                if (obj) {
  ...
  onFormValid(payload = this.form.getRawValue()) {
    this.subs.push(
      this.service
        .createNewCuriaMinistriesAndOrderDocument(this.id, payload)
        .subscribe(
          (response: any) => {
