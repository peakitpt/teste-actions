...
import {
  ...
  getCurrentAccountLinesListPriestlyFraternity,
  getPriest,
...
import { getGroups } from '../reducers/priests.selectors';
import { RequestGetAllGroups } from '../reducers/priests.actions';
...
@Component({
  selector: 'kyr-priests-details',
  templateUrl: './priests-details.component.html',
  encapsulation: ViewEncapsulation.None,
})
export class PriestsDetailsComponent
  ...
  implements OnInit, AfterViewInit, OnDestroy
{
  ...
  @ViewChild('subscription_dateTemplate')
  subscription_dateTemplate: TemplateRef<any>;
  @ViewChild('unsubscription_dateTemplate')
  unsubscription_dateTemplate: TemplateRef<any>;
  ...
  afterGetModel() {
    ...
    this.buildFields();
    this.store
      .select(getCurrentAccountLinesListPriestlyFraternity)
      .subscribe((val) => {
    ...
    this.dataSourceColumnsPriestlyCards = [
      {
        ...
        title: this.i18nextPipe.transform(
          `${this.modulePath}:model.entity_priest_priestly_cards.renewal_date`
        ),
      },
    ];
    ...
    this.dataSourceColumnsRetreats = [
      {
        id: 'retreat_year',
        title: this.i18nextPipe.transform(
          `${this.modulePath}:model.entity_priest_retreats.retreat_year`
        ),
      },
      {
        id: 'retreat_place',
        title: this.i18nextPipe.transform(
          `${this.modulePath}:model.entity_priest_retreats.retreat_place`
        ),
      },
    ];
    ...
    this.dataSourceColumnsOngoingFormations = [
      {
        id: 'start_date',
        title: this.i18nextPipe.transform(
          `${this.modulePath}:model.entity_priest_ongoing_formations.start_date`
        ),
      },
      {
        id: 'end_date',
        title: this.i18nextPipe.transform(
          `${this.modulePath}:model.entity_priest_ongoing_formations.end_date`
        ),
      },
      {
        id: 'description',
        title: this.i18nextPipe.transform(
          `${this.modulePath}:model.entity_priest_ongoing_formations.description`
        ),
      },
    ];
    ...
    this.dataSourceColumnsPublications = [
      {
        id: 'publication_date',
        title: this.i18nextPipe.transform(
          `${this.modulePath}:model.entity_priest_publications.publication_date`
        ),
      },
      {
        id: 'description',
        title: this.i18nextPipe.transform(
          `${this.modulePath}:model.entity_priest_publications.description`
        ),
      },
    ];
    ...
    this.dataSourceColumnsCurriculums = [
      {
        id: 'start_date',
        title: this.i18nextPipe.transform(
          `${this.modulePath}:model.entity_priest_curriculums.start_date`
        ),
      },
      {
        id: 'end_date',
        title: this.i18nextPipe.transform(
          `${this.modulePath}:model.entity_priest_curriculums.end_date`
        ),
      },
      {
        id: 'description',
        title: this.i18nextPipe.transform(
          `${this.modulePath}:model.entity_priest_curriculums.description`
        ),
      },
    ];
    ...
    this.dataSourceColumnsAcademicQualifications = [
      {
        id: 'start_date',
        title: this.i18nextPipe.transform(
          `${this.modulePath}:model.entity_priest_academic_qualifications.start_date`
        ),
      },
      {
        id: 'end_date',
        title: this.i18nextPipe.transform(
          `${this.modulePath}:model.entity_priest_academic_qualifications.end_date`
        ),
      },
      {
        id: 'description',
        title: this.i18nextPipe.transform(
          `${this.modulePath}:model.entity_priest_academic_qualifications.description`
        ),
      },
    ];
  }
  ...
  buildFields() {
    this.detailsFields = [
        ...
        fields: [
          ...
          new Section({
            ...
            fields: [
              ...
              new ImageField({
                label: this.i18nextPipe.transform(
                  `${this.modulePath}:model.entity.photo_url`
                ),
              ...
              new IconField({
                label: this.i18nextPipe.transform(
                  `${this.modulePath}:model.retired`
                ),
                model: this.model.retired,
                icon_true: 'check_box',
                icon_false: 'check_box_outline_blank',
              }),
              new DateField({
                label: this.i18nextPipe.transform(
                  `${this.modulePath}:model.retired_date`
                ),
                model: this.model.retired_date,
                isVisible: this.model.retired_date,
              }),
              new TextField({
                label: this.i18nextPipe.transform(
                  `${this.modulePath}:model.title_for_documents`
                ),
              ...
              new TextField({
                label: this.i18nextPipe.transform(
                  `${this.modulePath}:model.birth_chapelry_description`
                ),
              ...
              new ImageField({
                label: this.i18nextPipe.transform(
                  `${this.modulePath}:model.coat_of_arms_filename`
                ),
          ...
          new Section({
            id: 'address',
            label: this.i18nextPipe.transform(
              `${this.modulePath}:header.address`
            ),
            fields: [
              new TextField({
                label: this.i18nextPipe.transform(
                  `${this.modulePath}:model.residence`
                ),
              ...
              new TextField({
                label: this.i18nextPipe.transform(
                  `${this.modulePath}:model.residence_chapelry_description`
                ),
              ...
              new TextField({
                label: this.i18nextPipe.transform(
                  `${this.modulePath}:model.entity.district`
                ),
          ...
          new Section({
            id: 'contacts',
            label: this.i18nextPipe.transform(
              `${this.modulePath}:header.contacts`
            ),
            fields: [
              new TextField({
                label: this.i18nextPipe.transform(
              ...
              new TextField({
                label: this.i18nextPipe.transform(
                  `${this.modulePath}:model.private_mobilephone`
                ),
              ...
              new TextField({
                label: this.i18nextPipe.transform(
                  `${this.modulePath}:model.entity.fax`
                ),
          ...
          new Section({
            ...
            label: this.i18nextPipe.transform(
              `${this.modulePath}:header.identification_documents`
            ),
            isVisible:
            ...
            fields: [
              new TextField({
                label: this.i18nextPipe.transform(
                  `${this.modulePath}:model.entity_person.ident_document_type`
                ),
              ...
              new TextField({
                label: this.i18nextPipe.transform(
                  `${this.modulePath}:model.entity_person.ident_document_number`
                ),
              ...
              new TextField({
                label: this.i18nextPipe.transform(
                  `${this.modulePath}:model.entity_person.ident_document_emission_date`
                ),
              ...
              new TextField({
                label: this.i18nextPipe.transform(
                  `${this.modulePath}:model.entity_person.ident_document_emitted_by`
                ),
              ...
              new TextField({
                label: this.i18nextPipe.transform(
                  `${this.modulePath}:model.entity_person.ident_document_validity_date`
                ),
          ...
          new Section({
            id: 'filiation',
            label: this.i18nextPipe.transform(
              `${this.modulePath}:header.filiation`
            ),
            isVisible:
          ...
          new Section({
            ...
            label: this.i18nextPipe.transform(
              `${this.modulePath}:header.other_informations`
            ),
            fields: [
              new TextField({
                label: this.i18nextPipe.transform(
      ...
      new Tab({
        ...
        textLabel: this.i18nextPipe.transform(
          `${this.modulePath}:tabs.ordination_appointmens`
        ),
        ...
        fields: [
          new Section({
            id: 'ordination',
            label: this.i18nextPipe.transform(
              `${this.modulePath}:header.ordination`
            ),
            fields: [
              new DateField({
                label: this.i18nextPipe.transform(
              ...
              new TextField({
                label: this.i18nextPipe.transform(
                  `${this.modulePath}:model.ordination_place`
                ),
          ...
          new Section({
            id: 'appoitments',
            label: this.i18nextPipe.transform(
              `${this.modulePath}:header.appoitments`
            ),
            fields: [
              new TextField({
                label: this.i18nextPipe.transform(
                  `${this.modulePath}:model.imported_actual_appointments`
                ),
          ...
          new Section({
            id: 'appointments_active',
            label: this.i18nextPipe.transform(
              `${this.modulePath}:header.appointments_active`
            ),
            fields: [
              new TableField({
                dataSource: this.model.entity_priest_appointments.filter(
                  (item) => item.end_date == null
                ),
                dataSourceColumns: [
                  {
                    id: 'nomination_active',
                    title: '',
                    template: this.nominationActiveTemplate,
                    url: (row: any) => {
                      return `/nominations/${row.nomination_id}/details`;
                    },
                  },
                  {
                    id: 'start_date',
                    title: this.i18nextPipe.transform(
                      `${this.modulePath}:model.entity_priest_appointments.start_date`
                    ),
                  ...
                  },
                  {
                    ...
                    title: this.i18nextPipe.transform(
                      `${this.modulePath}:model.entity_priest_appointments.curia_function_description`
                    ),
                    template: this.tableLineTemplate,
                    url: (row: any) => {
                      return `/curia-functions/${row.curia_function_id}/details`;
                    },
                  },
                  {
                    id: 'appointment_place_description',
                    title: this.i18nextPipe.transform(
                      `${this.modulePath}:model.entity_priest_appointments.appointment_place_description`
                    ),
                    template: this.tableLineTemplate,
                    url: (row: any) => {
                  ...
                  },
                  {
                    ...
                    title: this.i18nextPipe.transform(
                      `${this.modulePath}:model.entity_priest_appointments.representing_description`
                    ),
                    template: this.tableLineTemplate,
                    url: (row: any) => {
                  ...
                  },
                  {
                    id: 'description',
                    title: this.i18nextPipe.transform(
                      `${this.modulePath}:model.entity_priest_appointments.description`
                    ),
                    template: this.tableLineTemplate,
                  },
                ],
          ...
          new Section({
            id: 'appointments_historic',
            label: this.i18nextPipe.transform(
              `${this.modulePath}:header.appointments_historic`
            ),
            fields: [
              new TableField({
                dataSource: this.model.entity_priest_appointments.filter(
                ...
                dataSourceColumns: [
                  ...
                  },
                  {
                    id: 'end_date',
                    title: this.i18nextPipe.transform(
                      `${this.modulePath}:model.entity_priest_appointments.end_date`
                    ),
                    template: this.tableLineTemplate,
                    type: 'date',
                  },
      ...
      new Tab({
        ...
        textLabel: this.i18nextPipe.transform(
          `${this.modulePath}:tabs.current_accounts`
        ),
        fields: [
          new Section({
            id: 'current_account_priestly_fraternity',
            label: this.i18nextPipe.transform(
              `${this.modulePath}:header.current_account_priestly_fraternity`
            ),
            fields: [
              new TableDataSearchField({
                fb: this.fb,
                selectorGetList: getCurrentAccountLinesListPriestlyFraternity,
                actionRequestGetAll:
                  actions.RequestGetAllCurrentAccountLinesPriestlyFraternity,
                store: this.store,
                id: this.id,
                ...
                fields: [
                  {
                    name: 'document_date',
                    label: this.i18nextPipe.transform(
                      `${this.modulePath}:current_account_priestly_fraternity.document_date`
                    ),
                    value: null,
                    type: 'dateRangeInput',
                  },
                  {
                    ...
                    label: this.i18nextPipe.transform(
                      `${this.modulePath}:current_account_priestly_fraternity.documents_status_description`
                    ),
                    value: null,
                    type: 'inputSelect',
                    options: [
                      ...
                      },
                      {
                        value: '1',
                        label: this.i18nextPipe.transform(
                          `${this.modulePath}:types.pending`
                        ),
                      },
                      {
                        value: '2',
                        label: this.i18nextPipe.transform(
                          `${this.modulePath}:types.partially_paid`
                        ),
                      },
                      {
                        value: '3',
                        label: this.i18nextPipe.transform(
                          `${this.modulePath}:types.paid`
                        ),
                      },
                      {
                        value: '4',
                        label: this.i18nextPipe.transform(
                          `${this.modulePath}:types.canceled`
                        ),
                      },
                    ],
                  },
                  {
                    name: 'serie_number',
                    label: this.i18nextPipe.transform(
                      `${this.modulePath}:current_account_priestly_fraternity.serie_number`
                    ),
                    value: null,
                    type: 'textInput',
                    mainField: true,
                  },
                  {
                    name: 'total_amount',
                    label: this.i18nextPipe.transform(
                      `${this.modulePath}:current_account_priestly_fraternity.total_amount`
                    ),
                    value: null,
                    type: 'textInput',
                  },
              ...
              new TableDataField({
                ...
                tableColumns: [
                  ...
                  },
                  {
                    id: 'currency',
                    title: this.i18nextPipe.transform(
                      `${this.modulePath}:current_account_priestly_fraternity.currency`
                    ),
                  },
                  {
                    id: 'total_amount',
                  ...
                  },
                  {
                    id: 'pending_amount',
                    title: this.i18nextPipe.transform(
                      `${this.modulePath}:current_account_priestly_fraternity.pending_amount`
                    ),
          ...
          new Section({
            ...
            label: this.i18nextPipe.transform(
              `${this.modulePath}:header.current_account_curia`
            ),
            fields: [
              new TableDataSearchField({
                fb: this.fb,
                ...
                fields: [
                  {
                    name: 'document_date',
                    label: this.i18nextPipe.transform(
                      `${this.modulePath}:current_account_curia.document_date`
                    ),
                    value: null,
                    type: 'dateRangeInput',
                  },
                  {
                    name: 'documents_status_id',
                    label: this.i18nextPipe.transform(
                      `${this.modulePath}:current_account_curia.documents_status_description`
                    ),
                    value: null,
                    type: 'inputSelect',
                    options: [
                  ...
                  },
                  {
                    name: 'serie_number',
                    label: this.i18nextPipe.transform(
                      `${this.modulePath}:current_account_curia.serie_number`
                    ),
                    value: null,
                    type: 'textInput',
                    mainField: true,
                  },
                  {
                    name: 'total_amount',
                    label: this.i18nextPipe.transform(
                      `${this.modulePath}:current_account_curia.total_amount`
                    ),
                    value: null,
                    type: 'textInput',
                  },
              ...
              new TableDataField({
                ...
                tableColumns: [
                  ...
                  },
                  {
                    id: 'currency',
                    title: this.i18nextPipe.transform(
                      `${this.modulePath}:current_account_curia.currency`
                    ),
                  },
                  {
                    id: 'total_amount',
                  ...
                  },
                  {
                    id: 'pending_amount',
                    title: this.i18nextPipe.transform(
                      `${this.modulePath}:current_account_curia.pending_amount`
                    ),
                    template: this.documentsPendingTemplate,
          ...
          new Section({
            ...
            fields: [
              new TableDataField({
                ...
                actionRequestGetAll: RequestGetAllGroups,
                store: this.store,
                id: this.id,
                tableColumns: [
                  {
                    id: 'group_name',
                    title: this.i18nextPipe.transform(
                      `${this.modulePath}:groups.group_name`
                    ),
                    template: this.tableLineTemplate,
                    url: (row: any) => {
                      return `/groups/${row.group_id}/details`;
                    },
                  },
                  {
                    id: 'subscription_date',
                    title: this.i18nextPipe.transform(
                      `${this.modulePath}:groups.subscription_date`
                    ),
                    template: this.subscription_dateTemplate,
                  },
                  {
                    id: 'unsubscription_date',
                    title: this.i18nextPipe.transform(
                      `${this.modulePath}:groups.unsubscription_date`
                    ),
                    template: this.unsubscription_dateTemplate,
                  },
                  {
                    id: 'active',
                    title: this.i18nextPipe.transform(
                      `${this.modulePath}:groups.active`
                    ),
      ...
      new Tab({
        name: 'other_infos',
        textLabel: this.i18nextPipe.transform(
          `${this.modulePath}:tabs.other_infos`
        ),
        isVisible:
        ...
        fields: [
          new Section({
            ...
            label: this.i18nextPipe.transform(
              `${this.modulePath}:header.priest_card_renewals`
            ),
          ...
          new Section({
            id: 'retreats',
            label: this.i18nextPipe.transform(
              `${this.modulePath}:header.retreats`
            ),
          ...
          new Section({
            ...
            label: this.i18nextPipe.transform(
              `${this.modulePath}:header.permanent_formation`
            ),
            isVisible:
              this.model.ongoing_formations ||
              this.model.entity_priest_ongoing_formations.length > 0,
            fields: [
              new TextField({
                label: this.i18nextPipe.transform(
                  `${this.modulePath}:model.ongoing_formations`
                ),
          ...
          new Section({
            id: 'publications',
            label: this.i18nextPipe.transform(
              `${this.modulePath}:header.publications`
            ),
            isVisible:
              this.model.publications ||
              this.model.entity_priest_publications.length > 0,
            fields: [
              new TextField({
                label: this.i18nextPipe.transform(
                  `${this.modulePath}:model.publications`
                ),
          ...
          new Section({
            id: 'curriculum',
            label: this.i18nextPipe.transform(
              `${this.modulePath}:header.curriculum`
            ),
            isVisible:
              this.model.curriculum ||
              this.model.entity_priest_curriculums.length > 0,
            fields: [
              new TextField({
                label: this.i18nextPipe.transform(
                  `${this.modulePath}:model.curriculum`
                ),
          ...
          new Section({
            ...
            label: this.i18nextPipe.transform(
              `${this.modulePath}:header.academic_qualifications`
            ),
            isVisible:
              this.model.priest_academic_qualifications ||
              this.model.entity_priest_academic_qualifications.length > 0,
            fields: [
              new TextField({
                label: this.i18nextPipe.transform(
                  `${this.modulePath}:model.priest_academic_qualifications`
                ),
    ...
    let mySub = this.actionSubject
      .pipe(
        ofType(
          ...
          actions.PriestActionTypes.SuccessActivateDeactivateGroup
        )
      )
