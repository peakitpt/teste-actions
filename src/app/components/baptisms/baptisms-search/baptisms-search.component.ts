...
@Component({
  selector: 'kyr-baptisms-search',
  templateUrl: './baptisms-search.component.html',
  encapsulation: ViewEncapsulation.None,
})
export class BaptismsSearchComponent
  ...
  buildForm() {
    this.form = this.fb.group({
      ...
      searchFields: this.fb.group({
        ...
        baptism_date_start: this.fb.group({
          searchWordLabel:
        ...
        baptism_date_end: this.fb.group({
          searchWordLabel:
            this.i18nextPipe.transform(
              `${this.modulePath}:model.baptism_date`
