...
@Injectable()
export class BaptismsEffects {
  @Effect()
  RequestGetAll = this.actions$.pipe(
    ofType(actions.BaptismsActionTypes.RequestGetAll),
    map((action: actions.SuccessGetAll) => action.payload),
    switchMap((payload) => {
      return this.service.getAll(payload).pipe(
        map((response: BaptismResponse) => new actions.SuccessGetAll(response)),
        catchError((error) =>
          of(
            new actions.RequestFail(
              new RequestError(actions.BaptismsActionTypes.RequestGetAll, error)
            )
          )
        )
      );
  ...
  RequestGet = this.actions$.pipe(
    ofType(actions.BaptismsActionTypes.RequestGet),
    map((action: actions.SuccessGet) => action.payload),
    switchMap((payload) => {
      return this.service.getOne(+payload).pipe(
        map((response: Baptism) => new actions.SuccessGet(response)),
        catchError((error) =>
          of(
            new actions.RequestFail(
              new RequestError(actions.BaptismsActionTypes.RequestGet, error)
            )
          )
        )
      );
  ...
  RequestPost = this.actions$.pipe(
    ofType(actions.BaptismsActionTypes.RequestPost),
    ...
    switchMap((payload) => {
      return this.service.create(payload).pipe(
        ...
        catchError((error) => {
          return of(
            new actions.RequestFail(
              new RequestError(actions.BaptismsActionTypes.RequestPost, error)
            )
          );
        })
      );
  ...
  RequestPut = this.actions$.pipe(
    ofType(actions.BaptismsActionTypes.RequestPut),
    ...
    switchMap((payload) => {
      return this.service.update(payload).pipe(
        ...
        catchError((error) =>
          of(
            new actions.RequestFail(
              new RequestError(actions.BaptismsActionTypes.RequestPut, error)
            )
          )
        )
      );
  ...
  RequestDelete = this.actions$.pipe(
    ofType(actions.BaptismsActionTypes.RequestDelete),
    ...
    switchMap((payload) => {
      return this.service.delete(+payload).pipe(
        ...
        catchError((error) =>
          of(
            new actions.RequestFail(
              new RequestError(actions.BaptismsActionTypes.RequestDelete, error)
            )
          )
        )
      );
  ...
  RequestBulkDelete = this.actions$.pipe(
    ofType(actions.BaptismsActionTypes.RequestBulkDelete),
      ...
      return this.service.bulkDelete(payload).pipe(
        ...
        catchError((error) => {
          return of(
            new actions.RequestFail(
              new RequestError(
                actions.BaptismsActionTypes.RequestBulkDelete,
                error
              )
            )
          );
  ...
  RequestGetEntirely = this.actions$.pipe(
    ofType(actions.BaptismsActionTypes.RequestGetEntirely),
      ...
      return this.service.getAll(payload.payload).pipe(
        ...
        catchError((error) =>
          of(
            new actions.RequestFail(
              new RequestError(
                actions.BaptismsActionTypes.RequestGetEntirely,
                error
              )
            )
          )
  ...
  RequestSaveAndGenerateDocument = this.actions$.pipe(
    ofType(actions.BaptismsActionTypes.RequestSaveAndGenerateDocument),
    map((action: actions.SuccessSaveAndGenerateDocument) => action.payload),
    switchMap((payload) => {
      return this.service.saveAndGenerateDocument(payload as Baptism).pipe(
        map((response) => new actions.SuccessSaveAndGenerateDocument(response)),
        catchError((error) =>
          of(
            new actions.RequestFailSaveAndGenerateDocument(
              new RequestError(
                actions.BaptismsActionTypes.RequestSaveAndGenerateDocument,
                error
              )
            )
          )
  ...
  RequestSendToCuria = this.actions$.pipe(
    ofType(actions.BaptismsActionTypes.RequestSendToCuria),
      ...
      return this.service.sendToCuria(payload).pipe(
        ...
        catchError((error) => {
          return of(
            new actions.RequestFail(
              new RequestError(
                actions.BaptismsActionTypes.RequestSendToCuria,
                error
              )
            )
          );
  ...
  constructor(private actions$: Actions, private service: BaptismsService) {}
}
